...
`},{link:"blog-5",img:"",title:"Introduction to Forex Trading with The Funded Hub: A Beginner's Guide",para:`<span></span> Explore the power of leverage
          ...
          `},{link:"blog-12",img:"",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function Ve(){let[a,i]=t.useState(1);const s=6,n=Math.ceil($.length/s),r=Ye($,s),o=(h,p)=>{i(p),r.jump(p)},l=fe({palette:{mode:"dark"}});return e.jsxs(e.Fragment,{children:[e.jsx(j,{}),e.jsxs("section",{className:"blog relative pt-36 sm:pt-48 pb-28 sm:pb-44 overflow-hidden",children:[e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"header flex justify-between w-full",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.7rem] tracking-tight text-wht-gradient",children:"Blog"})}),e.jsx("div",{className:"blogs mt-12 grid sm:grid-cols-2 md:grid-cols-3 gap-6 relative",children:r.currentData().map((h,p)=>e.jsxs(u,{to:`/blog/${h.link}`,className:"single-blog p-[0.9rem] bg-light/20 backdrop-blur-3xl rounded-xl !relative global-shadow grid justify-between items-end gap-4",children:[e.jsx("div",{className:"blog-img rounded-md hidden",children:e.jsx("img",{className:"rounded-md w-full h-full leading-none",src:h.img,alt:h.alt})}),e.jsxs("div",{className:"texts fmt-6 grid gap-3 pb-8",children:[e.jsx("h3",{className:"font-semibold",children:h.title}),e.jsx("div",{className:"blog-para-slice",children:e.jsx("p",{dangerouslySetInnerHTML:{__html:h.para.slice(0,140)+"...."}})}),e.jsx("div",{className:"date text-sm absolute bottom-3",children:h.date})]})]},h.title+p))}),e.jsx("div",{className:"pagination mt-10 flex justify-center",children:e.jsx(ge,{theme:l,children:e.jsx(ye,{spacing:2,children:e.jsx(ve,{count:n,page:a,shape:"rounded",variant:"outlined",color:"secondary",onChange:o})})})})]})}),e.jsx("div",{className:"circle-shadow absolute opacity-[23%] -top-[10%] -left-[50%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:T,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow absolute opacity-[25%] top-[40%] -right-[20%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:T,alt:"circle-shadow"})})]}),e.jsx(b,{})]})}function Ge(){const{pathname:a}=w(),i=$.filter(({link:s})=>s===a.slice(6));return e.jsxs(e.Fragment,{children:[e.jsx(j,{}),e.jsx("section",{className:"single-blog relative pt-16f pt-24 sm:pt-20 pb-28 sm:pb-44 overflow-hidden",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"flex justify-center items-center blog-content",children:e.jsx("div",{className:"blog-img p-[0.03rem] rounded-md",children:e.jsx("img",{className:"rounded-md",src:"",alt:i.alt})})}),e.jsxs("div",{className:"blog-content ",children:[e.jsx("div",{className:"heading",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.9rem] tracking-tight text-wht-gradient",children:i[0].title})}),e.jsxs("div",{className:"blog-wrap-data global-shadow",children:[e.jsx("div",{className:"data ",dangerouslySetInnerHTML:{__html:i[0].data}}),e.jsx("div",{className:"btn mt-10 m-auto max-w-[17rem]",children:e.jsx(u,{link:"/#price-table",className:"uppercase font-Montserrat text-sm font-semibold  transition-all duration-200 glowing-btn",children:"Get Funded Now"})})]})]})]})})}),e.jsx(b,{})]})}function Ke(){return e.jsxs(e.Fragment,{children:[e.jsx(j,{}),e.jsx("section",{className:"relative purple-shadow h-[450px] md:h-[550px] lg:h-[650px]",children:e.jsx("div",{className:"container z-10 relative h-full",children:e.jsxs("div",{className:"wrapper h-full flex flex-col gap-4 justify-center items-center text-center text-2xl sm:text-3xl md:text-[2rem] lg:text-4xl",children:[e.jsx("h1",{children:"Sorry, your payment is unsuccessful :("}),e.jsx("h1",{className:"text-3xl text-primary",children:"Please try again"})]})})}),e.jsx(b,{})]})}function _e({children:a}){const[i,s]=t.useState("UNPAID"),[n,r]=t.useState(!0),[o,l]=t.useState(localStorage.getItem("purchaseUuid")),h=ue();t.useEffect(()=>{l(localStorage.getItem("purchaseUuid"))},[]);const p="https://api.thefundedhub.com",m=window.location.href.split("session=")[1],S=()=>{o&&m?O.put(`${p}/v1/website/purchases/${o}`,{paymentReference:m}).then(k=>{s(k.data.data.status),r(!1),localStorage.removeItem("purchaseUuid")}).catch(()=>{r(!1)}):h("/")};return t.useEffect(()=>{setTimeout(S)},[]),n?e.jsxs("div",{className:"flex justify-center items-center h-screen flex-col gap-4",children:[e.jsx("div",{className:"loader text-primary text-4xl xs:text-5xl",children:"Loading..."}),e.jsx("div",{className:"flex justify-center items-center mt-4",children:e.jsx(xe,{strokeColor:"#C7B3FC",strokeWidth:"5",animationDuration:"0.75",width:"80",visible:!0})})]}):e.jsx(e.Fragment,{children:i==="PAID"?a:e.jsx(pe,{to:"/payment-error"})})}_.initialize("G-0GFK77GQTB");_.send({hitType:"pageview",page:window.location.pathname});const Je="ef72a2fc-1672-41b9-acd5-260aac3e06ba";function Xe(){return e.jsxs("div",{className:"App body-background",children:[e.jsx(oe,{children:e.jsxs(me,{children:[e.jsx(x,{path:"/",element:e.jsx(Le,{})}),e.jsx(x,{path:"contact-us",element:e.jsx(Oe,{})}),e.jsx(x,{path:"report-problem",element:e.jsx(Me,{})}),e.jsx(x,{path:"faq",element:e.jsx(qe,{})}),e.jsx(x,{path:"cookie-policy",element:e.jsx($e,{})}),e.jsx(x,{path:"privacy-policy",element:e.jsx(We,{})}),e.jsx(x,{path:"terms-condition",element:e.jsx(ze,{})}),e.jsx(x,{path:"risk-disclosure",element:e.jsx(Be,{})}),e.jsx(x,{path:"payment-error",element:e.jsx(Ke,{})}),e.jsx(x,{path:"thank-you",element:e.jsx(_e,{children:e.jsx(Ue,{})})}),e.jsx(x,{path:"blog",element:e.jsx(Ve,{})}),e.jsx(x,{path:"blog/:blog",element:e.jsx(Ge,{})})]})}),e.jsx(Z,{defer:!0,zendeskKey:Je})]})}ne.createRoot(document.getElementById("root")).render(e.jsx(se.StrictMode,{children:e.jsx(Xe,{})}));
