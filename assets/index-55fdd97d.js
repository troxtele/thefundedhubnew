import{r as t,j as e,a as le}from"./react-eaab5ef2.js";import{c as de}from"./react-dom-d3eb90c1.js";import{L as p,B as ce}from"./react-router-dom-085c26a6.js";import{R as te}from"./react-ga-ba683049.js";import{a as q}from"./axios-21b846bc.js";import{S as he,N as ue,a as B}from"./swiper-fe0503f0.js";import{R as pe}from"./react-icons-ac68b55c.js";import{b as T,a as me,d as fe,e as ge,f as b}from"./react-router-9803986a.js";import{P as J}from"./prop-types-67b1fb73.js";import{c as ye,T as xe,S as ve,P as be}from"./@mui-d808bd18.js";import{R as we}from"./react-loader-spinner-2be84f58.js";import"./hoist-non-react-statics-95ec5a95.js";import"./scheduler-765c72db.js";import"./@remix-run-d753ad9e.js";import"./ssr-window-c9202916.js";import"./react-is-e5978b8b.js";import"./@babel-5d790daf.js";import"./clsx-1229b3e0.js";import"./@emotion-8b66b15f.js";import"./stylis-79144faa.js";import"./react-transition-group-0db4bb7d.js";import"./styled-components-edc81f87.js";import"./styled-tools-bf41095e.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const c of s)if(c.type==="childList")for(const h of c.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&o(h)}).observe(document,{childList:!0,subtree:!0});function n(s){const c={};return s.integrity&&(c.integrity=s.integrity),s.referrerPolicy&&(c.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?c.credentials="include":s.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function o(s){if(s.ep)return;s.ep=!0;const c=n(s);fetch(s.href,c)}})();const $="/assets/logo-f6759efc.webp",w="/assets/arrow-cfc95aca.svg",F="/assets/circle-56f758db.webp",P="/assets/half-circle-d6403a1d.webp",X="/assets/meta-trader-5-ec51858e.webp",Z="/assets/meta-trader-4-873c0a4f.webp";function je(){const[a,i]=t.useState(!1),[n,o]=t.useState(),[s,c]=t.useState(""),[h,u]=t.useState(""),[m,x]=t.useState(""),[g,I]=t.useState(!0),[S,E]=t.useState(!0),[v,L]=t.useState(!1);t.useEffect(()=>{/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(n)&&n!==""?E(!0):v&&E(!1)},[n,g]);const[r,y]=t.useState("100000"),[C,O]=t.useState("0"),[A,M]=t.useState("5"),[f,V]=t.useState("5"),[k,Y]=t.useState("10"),[z,G]=t.useState("8"),[D,se]=t.useState(0),[R,K]=t.useState("meta-5"),l={5e3:{maxDailyLossVal:["$ 250 (5%)","$ 200 (4%)"],maxOverallLossVal:["$ 600 (12%)","$ 500 (10%)","$ 400 (8%)"],profitTargetVal:["$ 500 (10%)","$ 400 (8%)","$ 250 (5%)"],monthlySalaryVal:["$ 50.00/Month"]},1e4:{maxDailyLossVal:["$ 500 (5%)","$ 400 (4%)"],maxOverallLossVal:["$ 1,200 (12%)","$ 1,000 (10%)","$ 800 (8%)"],profitTargetVal:["$ 1,000 (10%)","$ 800 (8%)","$ 500 (5%)"],monthlySalaryVal:["$ 100.00/Month"]},25e3:{maxDailyLossVal:["$ 1,250 (5%)","$ 1,000 (4%)"],maxOverallLossVal:["$ 3,000 (12%)","$ 2,500 (10%)","$ 2,000 (8%)"],profitTargetVal:["$ 2,500 (10%)","$ 2,000 (8%)","$ 1,250 (5%)"],monthlySalaryVal:["$ 250.00/Month"]},5e4:{maxDailyLossVal:["$ 2,500 (5%)","$ 2,000 (4%)"],maxOverallLossVal:["$ 6,000 (12%)","$ 5,000 (10%)","$ 4,000 (8%)"],profitTargetVal:["$ 5,000 (10%)","$ 4,000 (8%)","$ 2,500 (5%)"],monthlySalaryVal:["$ 500.00/Month"]},1e5:{maxDailyLossVal:["$ 5,000 (5%)","$ 4,000 (4%)"],maxOverallLossVal:["$ 12,000 (12%)","$ 10,000 (10%)","$ 8,000 (8%)"],profitTargetVal:["$ 10,000 (10%)","$ 8,000 (8%)","$ 5,000 (5%)"],monthlySalaryVal:["$ 1000.00/Month"]},2e5:{maxDailyLossVal:["$ 10,000 (5%)","$ 8,000 (4%)"],maxOverallLossVal:["$ 24,000 (12%)","$ 20,000 (10%)","$ 16,000 (8%)"],profitTargetVal:["$ 20,000 (10%)","$ 16,000 (8%)","$ 10,000 (5%)"],monthlySalaryVal:["$ 2000.00/Month"]}},_="https://api.thefundedhub.com";t.useEffect(()=>{const d=`${_}/v1/website/prices?startingCapital=${r}&phase1MaximumTradingDays=${C}&phase1MinimumTradingDays=${A}&phase1ProfitTargetPercentage=${z}&phase1MaximumDailyLossPercentage=${f}&phase1MaximumTotalLossPercentage=${k}`;q.get(d).then(H=>{se(H.data.data.totalPrice)}).catch(H=>{console.error("There was an error!",H)})},[r,f,k,z,A,C]);const ne=()=>{q.post(`${_}/v1/website/purchases`,{voucherCode:m,email:n,firstName:s,lastName:h,paymentProvider:"STRIPE",platform:"MT5",startingCapital:r,phase1MaximumTradingDays:C,phase1MinimumTradingDays:A,phase1ProfitTargetPercentage:z,phase1MaximumDailyLossPercentage:f,phase1MaximumTotalLossPercentage:k}).then(d=>{const H=d.data.data;localStorage.setItem("purchaseUuid",H.uuid),window.location.replace(d.data.data.paymentUrl)})};t.useEffect(()=>{/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(n)&&n!==""?E(!0):v&&E(!1)},[n,g]);const oe=d=>{d.preventDefault(),I(!1),s&&h&&S?ne():L(!0)};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{id:"price-table",className:"price-table relative z-50 before:absolute before:h-36 before:w-full before:z-10",children:[e.jsxs("div",{className:"desktop-content relative z-[999] hidden lg:grid gap-2 w-full backdrop-blur-3xl rounded-2xl font-Montserrat",children:[e.jsxs("div",{className:"left grid grid-cols-5 items-center justify-start gap-2  font-medium relative",children:[e.jsx("div",{className:"price-table-border relative grid col-span-3 gap-5 h-full rounded-3xl",children:e.jsxs("div",{className:"heading p-5 h-full grid gap-3 rounded-3xl price-table-bg relative",children:[e.jsxs("h3",{className:"font-light",children:[e.jsx("b",{className:"font-bold",children:"Step 1: "})," Choose your Balance"]}),e.jsxs("div",{className:"prices flex flex-wrap gap-4",children:[e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-[5.5rem] py-2.5 rounded-mds border-b-2 leading-[0.7] ${r==="5000"?"border-primary":"border-primary/10"}`,onClick:()=>y("5000"),children:"$ 5,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-[5.5rem] py-2.5 rounded-mds border-b-2 leading-[0.7] ${r==="10000"?"border-primary":"border-primary/10"}`,onClick:()=>y("10000"),children:"$ 10,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-[5.5rem] py-2.5 rounded-mds border-b-2 leading-[0.7] ${r==="25000"?"border-primary":"border-primary/10"}`,onClick:()=>y("25000"),children:"$ 25,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-[5.5rem] py-2.5 rounded-mds border-b-2 leading-[0.7] ${r==="50000"?"border-primary":"border-primary/10"}`,onClick:()=>y("50000"),children:"$ 50,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-[5.5rem] py-2.5 rounded-mds border-b-2 leading-[0.7] ${r==="100000"?"border-primary":"border-primary/10"}`,onClick:()=>y("100000"),children:"$ 100,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-[5.5rem] py-2.5 rounded-mds border-b-2 leading-[0.7] ${r==="200000"?"border-primary":"border-primary/10"}`,onClick:()=>y("200000"),children:"$ 200,000"})})]})]})}),e.jsx("div",{className:"price-table-border col-span-2 relative",children:e.jsxs("div",{className:"right-inside p-5 rounded-3xl h-full price-table-bg",children:[e.jsx("div",{className:"heading",children:e.jsxs("h3",{className:"font-light",children:[e.jsx("b",{className:"font-bold",children:"Step 2: "})," Choose your Platform"]})}),e.jsxs("div",{className:"tranders flex gap-3 items-center w-full mt-2 relative z-30",children:[e.jsxs("div",{className:`img scale-105 transition-all duration-200 py-2 px-6 rounded-3xl bg-light/30 relative group ${R==="meta-4"?"border-primary":"border-transparent "}`,children:[e.jsx("img",{className:"max-w-[7rem] w-full relative opacity-20",src:Z,alt:"scop-markets"}),e.jsx("div",{className:"coming-soon absolute transition-all duration-200 opacity-0 group-hover:opacity-100 left-1/2 transform -translate-x-1/2 whitespace-nowrap -bottom-[1rem]",children:e.jsx("h6",{className:"text-[0.65rem]",children:"Available Soon!"})})]}),e.jsx("div",{className:`img scale-100 hover:scale-105 transition-all duration-200 py-2 px-6 rounded-3xl bg-light/60 border hover:border-primary cursor-pointer ${R==="meta-5"?"border-primary":"border-transparent "}`,onClick:()=>K("meta-5"),children:e.jsx("img",{className:"max-w-[7rem] w-full opacity-[0.87]",src:X,alt:"meta-trader-5"})})]})]})})]}),e.jsx("div",{className:"price-table-border relative",children:e.jsxs("div",{className:"grid rounded-3xl w-full p-7 price-table-bg",children:[e.jsx("div",{className:"heading mb-8",children:e.jsxs("h3",{children:[e.jsx("b",{className:"font-bold",children:"Step 3:"})," Customize your Challenge"]})}),e.jsxs("div",{className:"item grid grid-cols-10 gap-6 px-4 py-3 border-b border-primary/10 text-center relative z-[50]",children:[e.jsxs("span",{className:"col-span-4 text-start flex items-center gap-1",children:["Trading ",e.jsx("b",{className:"font-bold",children:" Period "}),":"]}),e.jsx("div",{className:"col-span-2 relative before:absolute before:font-bold before:content-['Phase_1'] flex justify-center before:-top-10 before:text-[0.9rem] whitespace-nowrap !font-normal",children:e.jsxs("div",{className:"wrap relative",children:[e.jsxs("select",{id:"treading-period",name:"treading-period",onChange:d=>O(d.target.value),className:"price-table-select",children:[e.jsx("option",{value:"0",children:"Unlimited"}),e.jsx("option",{value:"45",children:"45 Days"}),e.jsx("option",{value:"30",children:"30 Days"})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:w,alt:"arrow"})})]})}),e.jsx("div",{className:"col-span-2 flex justify-center",children:e.jsx("div",{className:"relative before:absolute before:font-bold before:content-['Phase_2'] flex justify-center before:-top-10 before:text-[0.9rem] font-normal whitespace-nowrap",children:e.jsx("div",{className:"col-span-2 flex justify-center items-center",children:e.jsx("span",{className:"priceVal",children:C==="0"?"Unlimited":C==="45"?"45 Days":"60 Days"})})})}),e.jsx("span",{className:"col-span-2 relative before:absolute before:font-bold before:content-['Funded'] before:-top-10 flex justify-center items-center",children:"Unlimited"})]}),e.jsxs("div",{className:"item grid grid-cols-10 gap-6 px-4 py-3 border-b border-primary/10 text-center relative z-40",children:[e.jsxs("span",{className:"col-span-4 text-start flex items-center gap-1",children:["Minimum Trading ",e.jsx("b",{className:"font-bold",children:" Days"}),":"]}),e.jsx("span",{className:"col-span-2 flex justify-center ",children:e.jsxs("div",{className:"wrap relative",children:[e.jsxs("select",{id:"treading-period",name:"treading-period",onChange:d=>M(d.target.value),className:"price-table-select",children:[e.jsx("option",{value:"0",children:"0 Days"}),e.jsx("option",{value:"3",children:"3 Days"}),e.jsx("option",{selected:!0,value:"5",children:"5 Days"})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:w,alt:"arrow"})})]})}),e.jsx("span",{className:"col-span-2 flex justify-center",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:A==="0"?"0 Days":A==="3"?"3 Days":"5 Days"})}),e.jsx("span",{className:"col-span-2 flex justify-center items-center",children:"-"})]}),e.jsxs("div",{className:"item grid grid-cols-10 gap-6 px-4 py-3 border-b border-primary/10 text-center relative z-30",children:[e.jsxs("span",{className:"col-span-4 text-start mt-[0.13rem] flex items-center gap-1",children:["Max ",e.jsx("b",{className:"font-bold",children:" Daily "})," Loss:"]}),e.jsx("div",{className:"col-span-2 ",children:e.jsxs("span",{className:"priceVal inline-flex justify-center items-center relative",children:[e.jsxs("select",{id:"daily-loss",name:"daily-loss",onChange:d=>V(d.target.value),className:"price-table-select",children:[e.jsx("option",{value:"4",children:l[r].maxDailyLossVal[1]}),e.jsx("option",{selected:!0,value:"5",children:l[r].maxDailyLossVal[0]})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:w,alt:"arrow"})})]})}),e.jsx("div",{className:"col-span-2 flex justify-center items-center",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:f==="5"?l[r].maxDailyLossVal[0]:l[r].maxDailyLossVal[1]})}),e.jsx("div",{className:"col-span-2 flex justify-center items-center gap-1",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:f==="5"?l[r].maxDailyLossVal[0]:l[r].maxDailyLossVal[1]})})]}),e.jsxs("div",{className:"item grid grid-cols-10 gap-6 px-4 py-3 border-b border-primary/10 text-center relative z-20 ",children:[e.jsxs("span",{className:"col-span-4 text-start pt-[0.1rem] flex items-center gap-1",children:["Max ",e.jsx("b",{className:"font-bold",children:"Overall "})," Loss:"]}),e.jsx("div",{className:"col-span-2",children:e.jsxs("span",{className:"priceVal inline-flex justify-center items-center relative",children:[e.jsxs("select",{id:"daily-loss",name:"daily-loss",onChange:d=>Y(d.target.value),className:"price-table-select",children:[e.jsx("option",{value:"8",children:l[r].maxOverallLossVal[2]}),e.jsx("option",{selected:!0,value:"10",children:l[r].maxOverallLossVal[1]}),e.jsx("option",{value:"12",children:l[r].maxOverallLossVal[0]})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:w,alt:"arrow"})})]})}),e.jsx("div",{className:"col-span-2 flex justify-center items-center",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:e.jsx("span",{children:k==="12"?l[r].maxOverallLossVal[0]:k==="10"?l[r].maxOverallLossVal[1]:l[r].maxOverallLossVal[2]})})}),e.jsx("div",{className:"col-span-2 flex justify-center items-center gap-1",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:k==="12"?l[r].maxOverallLossVal[0]:k==="10"?l[r].maxOverallLossVal[1]:l[r].maxOverallLossVal[2]})})]}),e.jsxs("div",{className:"item grid grid-cols-10 gap-6 px-4 py-3 border-b border-primary/10 text-center relative z-10",children:[e.jsxs("span",{className:"col-span-4 text-start mt-[0.13rem] flex items-center gap-1",children:["Profit ",e.jsx("b",{className:"font-bold",children:"Target"}),":"]}),e.jsx("div",{className:"col-span-2",children:e.jsxs("span",{className:"priceVal inline-flex justify-center items-center relative",children:[e.jsxs("select",{id:"daily-loss",name:"daily-loss",onChange:d=>G(d.target.value),className:"price-table-select",children:[e.jsx("option",{value:"8",children:l[r].profitTargetVal[1]}),e.jsx("option",{value:"10",children:l[r].profitTargetVal[0]})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:w,alt:"arrow"})})]})}),e.jsx("div",{className:"col-span-2 flex justify-center items-center gap-1",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:l[r].profitTargetVal[2]})}),e.jsx("span",{className:"col-span-2 flex justify-center items-center",children:"-"})]}),e.jsxs("div",{className:"item grid grid-cols-10 gap-6 px-4 py-3 border-b border-primary/10 text-center relative z-[5]",children:[e.jsx("span",{className:"col-span-4 text-start mt-[0.13rem]",children:"Leverage:"}),e.jsx("div",{className:"col-span-2",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:"1:100"})}),e.jsx("div",{className:"col-span-2",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:"1:100"})}),e.jsx("div",{className:"col-span-2",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:"1:100"})})]}),e.jsxs("div",{className:"item grid grid-cols-10 gap-6 px-4 py-3 border-b border-primary/10 text-center relative z-[0]",children:[e.jsxs("span",{className:"col-span-4 text-start mt-[0.13rem]",children:["Monthly ",e.jsx("b",{className:"font-bold",children:"Salary"}),":"]}),e.jsx("div",{className:"col-span-2",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:"-"})}),e.jsx("div",{className:"col-span-2",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:"-"})}),e.jsx("div",{className:"col-span-2",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:l[r].monthlySalaryVal[0]})})]})]})}),e.jsx("div",{className:"price-table-border relative",children:e.jsxs("div",{className:"bottom  relative flex justify-between py-7 px-12 rounded-3xl price-table-bg",children:[e.jsxs("div",{className:"wrap grid gap-1",children:[e.jsxs("div",{className:"refund flex items-center",children:[e.jsx("b",{className:"text-lg font-codePro",children:"Refundable fee:"}),e.jsxs("h4",{className:"text-[1.4rem] font-extrabold ml-4 w-28",children:["$ ",D]})]}),e.jsxs("div",{className:" font-Montserrat text-sm",children:["Or pay in 4 installments from"," ",e.jsxs("span",{className:"font-bold",children:["$",D/4]})," / Month",e.jsx("span",{className:"text-primary",children:" (coming soon)"})]})]}),e.jsx("div",{className:"btn flex justify-start items-center",children:e.jsx("div",{onClick:()=>i(!0),className:"home-glowing-btn cursor-pointer py-3 px-12 rounded-3xl uppercase font-bold",children:"Get Funded Now"})})]})})]}),e.jsxs("div",{className:"mobile-content relative z-20 lg:hidden flex flex-wrap justify-start items-center mt-2 ",children:[e.jsx("div",{className:"top font-medium w-full",children:e.jsx("div",{className:"heading flex justify-center",children:e.jsxs("div",{className:"prices grid grid-cols-3 gap-2",children:[e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-full p-3 xs:px-5 rounded-mdg text-[0.95] ex:text-base transition-all duration-300 leading-[0.7] whitespace-nowrap border rounded-full bg-light/40 relative before:absolute before:w-full before:h-full before:inset-0 before:rounded-full font-Montserrat price-btn-shadow ${r==="5000"?"border-primary":"border-primary/10"}`,onClick:()=>y("5000"),children:"$ 5,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-full p-3 xs:px-5 rounded-mdg text-[0.95] ex:text-base transition-all duration-300 leading-[0.7] whitespace-nowrap border rounded-full bg-light/40 relative before:absolute before:w-full before:h-full before:inset-0 before:rounded-full font-Montserrat price-btn-shadow ${r==="10000"?"border-primary":"border-primary/10"}`,onClick:()=>y("10000"),children:"$ 10,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-full p-3 xs:px-5 rounded-mdg text-[0.95] ex:text-base transition-all duration-300 leading-[0.7] whitespace-nowrap border rounded-full bg-light/40 relative before:absolute before:w-full before:h-full before:inset-0 before:rounded-full font-Montserrat price-btn-shadow ${r==="25000"?"border-primary":"border-primary/10"}`,onClick:()=>y("25000"),children:"$ 25,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-full p-3 xs:px-5 rounded-mdg text-[0.95] ex:text-base transition-all duration-300 leading-[0.7] whitespace-nowrap border rounded-full bg-light/40 relative before:absolute before:w-full before:h-full before:inset-0 before:rounded-full font-Montserrat price-btn-shadow ${r==="50000"?"border-primary":"border-primary/10"}`,onClick:()=>y("50000"),children:"$ 50,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-full p-3 xs:px-5 rounded-mdg text-[0.95] ex:text-base transition-all duration-300 leading-[0.7] whitespace-nowrap border rounded-full bg-light/40 relative before:absolute before:w-full before:h-full before:inset-0 before:rounded-full font-Montserrat price-btn-shadow ${r==="100000"?"border-primary":"border-primary/10"}`,onClick:()=>y("100000"),children:"$ 100,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-full p-3 xs:px-5 rounded-mdg text-[0.95] ex:text-base transition-all duration-300 leading-[0.7] whitespace-nowrap border rounded-full bg-light/40 relative before:absolute before:w-full before:h-full before:inset-0 before:rounded-full font-Montserrat price-btn-shadow ${r==="200000"?"border-primary":"border-primary/10"}`,onClick:()=>y("200000"),children:"$ 200,000"})})]})})}),e.jsxs("div",{className:"tranders grid items-center w-full relative z-30",children:[e.jsxs("p",{className:"mt-7 ml-5 relative before:absolute before:w-2 before:h-2 before:bg-white before:left-[-1rem] before:rounded-full before:top-1/2 before:transform before:-translate-y-1/2",children:[" ",e.jsx("b",{className:"font-bold",children:"Step 2:"})," ","  ","Customize your Platform:"]}),e.jsxs("div",{className:"wrap flex justify-center gap-3 mt-4",children:[e.jsxs("div",{className:`img scale-100 hover:scale-105 transition-all duration-200 py-2 px-6 rounded-3xl bg-light/30 relative price-btn-shadow  ${R==="meta-4"?"border-primary":"border-transparent "}`,children:[e.jsx("img",{className:"max-w-[7rem] w-full opacity-[0.87]f opacity-60 price-btn-shadow",src:Z,alt:"scop-markets"}),e.jsx("div",{className:"absolute transition-all duration-200  left-1/2 transform -translate-x-1/2 whitespace-nowrap -bottom-[1rem]",children:e.jsx("h6",{className:"text-[0.65rem]",children:"Available Soon!"})})]}),e.jsx("div",{className:`img transition-all duration-200 py-2 px-6 rounded-3xl bg-light/60 border hover:border-primary price-btn-shadow ${R==="meta-5"?"border-primary":"border-transparent"}`,onClick:()=>K("meta-5"),children:e.jsx("img",{className:"max-w-[7rem] w-full opacity-[0.87]",src:X,alt:"meta-trader-5"})})]})]}),e.jsx("div",{className:"step w-full",children:e.jsxs("p",{className:"mt-10 ml-5 relative before:absolute before:w-2 before:h-2 before:bg-white before:left-[-1rem] before:rounded-full before:top-1/2 before:transform before:-translate-y-1/2",children:[" ",e.jsx("b",{className:"font-bold",children:"Step 3:"})," ","  ","Customize your Challenge:"]})}),e.jsx("div",{className:"flex flex-wrap gap-8 md:gap-12 justify-center items-center -mx-[1.5rem] px-[1.5rem] w-screen sm:w-[70vw] sm:m-auto relative z-20",children:e.jsxs(he,{navigation:!0,grabCursor:!0,centeredSlides:!0,slidesPerView:"auto",modules:[ue],spaceBetween:30,className:"flex flex-wrap gap-8 md:gap-10 justify-center items-center w-full px-3 xs:px-6 mt-4 text-white",children:[e.jsx(B,{children:e.jsxs("div",{className:"phase1 pt-2 pb-6 item grid gap-3 border border-primary/20 rounded-3xl uni-bg-gradient h-full card-shadow",children:[e.jsx("div",{className:"heading pb-3 mt-2 ",children:e.jsx("h3",{className:"px-5 text-center m-auto max-w-[10rem] border-b-2 border-primary/30 pb-3 font-codeProBold font-extrabold",children:"Phase 1"})}),e.jsxs("div",{className:"items grid gap-4 px-4",children:[e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Trading",e.jsx("b",{className:"font-bold",children:" Period"}),":"]}),e.jsx("div",{children:e.jsx("div",{className:"wrap flex gap-2 justify-center items-center relative z-[10]",children:e.jsxs("div",{className:"wrap relative",children:[e.jsxs("select",{id:"treading-period",name:"treading-period",onChange:d=>O(d.target.value),className:"price-table-select",children:[e.jsx("option",{value:"0",children:"Unlimited"}),e.jsx("option",{value:"45",children:"45 Days"}),e.jsx("option",{value:"30",children:"30 Days"})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:w,alt:"arrow"})})]})})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center relative z-[9]",children:[e.jsxs("span",{children:["Min. Trading",e.jsx("b",{className:"font-bold",children:" Days"}),":"]}),e.jsxs("div",{className:"wrap relative",children:[e.jsxs("select",{id:"treading-period",name:"treading-period",onChange:d=>M(d.target.value),className:"price-table-select",children:[e.jsx("option",{value:"0",children:"0 Days"}),e.jsx("option",{value:"3",children:"3 Days"}),e.jsx("option",{selected:!0,value:"5",children:"5 Days"})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:w,alt:"arrow"})})]})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center relative z-[8]",children:[e.jsxs("span",{children:["Max",e.jsx("b",{className:"font-bold",children:" Daily "})," Loss:"]}),e.jsx("div",{children:e.jsxs("span",{className:"priceVal inline-flex justify-center items-center relative",children:[e.jsxs("select",{id:"daily-loss",name:"daily-loss",onChange:d=>V(d.target.value),className:"price-table-select",children:[e.jsx("option",{value:"4",children:l[r].maxDailyLossVal[1]}),e.jsx("option",{selected:!0,value:"5",children:l[r].maxDailyLossVal[0]})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:w,alt:"arrow"})})]})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center relative z-[7]",children:[e.jsxs("span",{children:["Max",e.jsx("b",{className:"font-bold",children:" Overall "})," Loss:"]}),e.jsx("div",{children:e.jsxs("span",{className:"priceVal inline-flex justify-center items-center relative",children:[e.jsxs("select",{id:"daily-loss",name:"daily-loss",onChange:d=>Y(d.target.value),className:"price-table-select",children:[e.jsx("option",{value:"8",children:l[r].maxOverallLossVal[2]}),e.jsx("option",{selected:!0,value:"10",children:l[r].maxOverallLossVal[1]}),e.jsx("option",{value:"12",children:l[r].maxOverallLossVal[0]})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:w,alt:"arrow"})})]})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center relative z-[6]",children:[e.jsxs("span",{children:["Profit ",e.jsx("b",{className:"font-bold",children:" Target "}),":"]}),e.jsx("div",{children:e.jsxs("span",{className:"priceVal inline-flex justify-center items-center relative",children:[e.jsxs("select",{id:"daily-loss",name:"daily-loss",onChange:d=>G(d.target.value),className:"price-table-select",children:[e.jsx("option",{value:"8",children:l[r].profitTargetVal[1]}),e.jsx("option",{value:"10",children:l[r].profitTargetVal[0]})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:w,alt:"arrow"})})]})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsx("span",{children:"Leverage:"}),e.jsx("div",{children:e.jsx("span",{className:"sm:w-[136px] flex justify-center",children:"1:100"})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Monthly ",e.jsx("b",{className:"font-bold",children:" Salary "}),":"]}),e.jsx("div",{children:e.jsx("span",{className:"sm:w-[136px] flex justify-center",children:"-"})})]})]})]})}),e.jsx(B,{children:e.jsxs("div",{className:"phase-2 pt-2 pb-6 item grid gap-3 border border-primary/20 rounded-3xl uni-bg-gradient h-full card-shadow",children:[e.jsx("div",{className:"heading pb-3 mt-2 ",children:e.jsx("h3",{className:"px-5 text-center m-auto max-w-[10rem] border-b-2 border-primary/30 pb-3 font-codeProBold font-extrabold",children:"Phase 2"})}),e.jsxs("div",{className:"items grid gap-6 px-4",children:[e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Trading",e.jsx("b",{className:"font-bold",children:" Period"}),":"]}),e.jsx("div",{children:e.jsx("div",{className:"wrap flex gap-2 justify-center items-center relative z-[10]",children:e.jsx("div",{className:"col-span-2 flex justify-center items-center sm:w-[136px]",children:e.jsx("span",{className:"priceVal",children:C==="0"?"Unlimited":C==="45"?"45 Days":"60 Days"})})})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center relative z-[9]",children:[e.jsxs("span",{children:["Min. Trading",e.jsx("b",{className:"font-bold",children:" Days"}),":"]}),e.jsx("span",{className:"priceVal inline-flex justify-center items-center sm:w-[136px]",children:A==="0"?"0 Days":A==="3"?"3 Days":"5 Days"})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Max",e.jsx("b",{className:"font-bold",children:" Daily "})," Loss:"]}),e.jsx("div",{children:e.jsx("span",{className:"priceVal sm:w-[136px] flex justify-center",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:f==="5"?l[r].maxDailyLossVal[0]:l[r].maxDailyLossVal[1]})})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Max",e.jsx("b",{className:"font-bold",children:" Overall "})," Loss:"]}),e.jsx("div",{children:e.jsx("span",{className:"priceVal sm:w-[136px] flex justify-center",children:e.jsx("span",{children:k==="12"?l[r].maxOverallLossVal[0]:k==="10"?l[r].maxOverallLossVal[1]:l[r].maxOverallLossVal[2]})})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Profit",e.jsx("b",{className:"font-bold",children:" target "}),":"]}),e.jsx("span",{className:"priceVal sm:w-[136px] flex justify-center",children:l[r].profitTargetVal[2]})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsx("span",{children:"Leverage:"}),e.jsx("div",{children:e.jsx("span",{className:"sm:w-[136px] flex justify-center",children:"1:100"})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Monthly ",e.jsx("b",{className:"font-bold",children:" Salary "}),":"]}),e.jsx("div",{children:e.jsx("span",{className:"sm:w-[136px] flex justify-center",children:"-"})})]})]})]})}),e.jsx(B,{children:e.jsxs("div",{className:"funded pt-2 pb-6 item grid gap-3 border border-primary/20 rounded-3xl uni-bg-gradient h-full card-shadow",children:[e.jsx("div",{className:"heading pb-3 mt-2 ",children:e.jsx("h3",{className:"px-5 text-center m-auto max-w-[10rem] border-b-2 border-primary/30 pb-3 font-codeProBold font-extrabold",children:"Funded"})}),e.jsxs("div",{className:"items grid gap-6 px-4",children:[e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Trading",e.jsx("b",{className:"font-bold",children:" Period"}),":"]}),e.jsx("div",{children:e.jsx("span",{className:"w-[122px] flex justify-center",children:"Unlimited"})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Min. Trading",e.jsx("b",{className:"font-bold",children:" Days"}),":"]}),e.jsx("span",{className:"w-[122px] flex justify-center",children:"-"})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Max",e.jsx("b",{className:"font-bold",children:" Daily "})," Loss:"]}),e.jsx("div",{children:e.jsx("span",{className:"w-[122px] flex justify-center",children:f==="5"?l[r].maxDailyLossVal[0]:l[r].maxDailyLossVal[1]})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Max",e.jsx("b",{className:"font-bold",children:" Overall "})," Loss:"]}),e.jsx("div",{children:e.jsx("span",{className:"w-[122px] flex justify-center",children:e.jsx("span",{children:k==="12"?l[r].maxOverallLossVal[0]:k==="10"?l[r].maxOverallLossVal[1]:l[r].maxOverallLossVal[2]})})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Profit",e.jsx("b",{className:"font-bold",children:" Target "}),":"]}),e.jsx("span",{className:"w-[122px] flex justify-center",children:"-"})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsx("span",{children:"Leverage:"}),e.jsx("div",{children:e.jsx("span",{className:"w-[122px] flex justify-center",children:"1:100"})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Monthly ",e.jsx("b",{className:"font-bold",children:" Salary "}),":"]}),e.jsx("div",{children:e.jsx("span",{className:"w-[122px] whitespace-nowrap flex justify-center",children:l[r].monthlySalaryVal[0]})})]})]})]})})]})}),e.jsxs("div",{className:"wrap mt-6 grid sm:grid-cols-2 justify-center items-center gap-4 w-full",children:[e.jsxs("div",{className:"grid justify-center",children:[e.jsxs("div",{className:"refund flex items-center justify-center",children:[e.jsx("span",{className:"!text-lg",children:"Refundable fee: "}),e.jsxs("h4",{className:"text-[1.5rem] font-Montserrat font-extrabold ml-4",children:["$ ",D]})]}),e.jsxs("div",{className:" font-Montserrat text-sm",children:["Or pay in 4 installments from"," ",e.jsxs("span",{className:"font-bold",children:["$",D/4]})," / Month"]})]}),e.jsx("div",{className:"btn flex w-full justify-center",children:e.jsx("div",{onClick:()=>i(!0),className:"font-Montserrat text-xs font-bold py-4 px-12  rounded-3xl home-glowing-btn uppercase",children:"Get Funded Now"})})]})]})]}),e.jsxs("div",{className:`modal fixed inset-0 z-[99999] transition-all duration-100 flex justify-center items-center overflow-hidden ${a?"visible opacity-100":"invisible opacity-0"}`,children:[e.jsx("div",{className:`bg absolute inset-0 w-full h-full transition-all duration-200 backdrop-blur-xl ${a?"opacity-100 ":"opacity-0"}`,onClick:()=>i(!1)}),e.jsxs("div",{className:`box relative m-6 max-w-[600px] w-full text-main text-wht bg-light-gray uni-bg-gradient transition-all duration-300 rounded-3xl z-[999] py-10 px-6 font-Montserrat ${a?"visible opacity-100":"invisible opacity-0"}`,children:[e.jsxs("form",{className:"content grid w-full text-center gap-4 font-semibold",children:[e.jsx("div",{className:"heading text-xl mt-6 font-Montserrat",children:e.jsx("h3",{children:"To proceed with your purchase, kindly fill out the form below"})}),e.jsxs("div",{className:"wrap grid sm:grid-cols-2 gap-7 mt-4",children:[e.jsxs("div",{className:"name relative",children:[e.jsx("input",{name:"name",onChange:d=>c(d.target.value),required:!0,className:`name w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${g||s!==""?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,type:"text",value:s,placeholder:"Name"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${g||s!==""?"invisible opacity-0":"visible opacity-100"}`,children:"This field is required"})]}),e.jsxs("div",{className:"surname relative",children:[e.jsx("input",{name:"surname",required:!0,onChange:d=>u(d.target.value),value:h,className:`lastName w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${g||s!==""?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,placeholder:"Surname"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${g||h!==""?"invisible opacity-0":"visible opacity-100"}`,children:"This field is required"})]}),e.jsxs("div",{className:"email relative col-span-full",children:[e.jsx("input",{name:"email",required:!0,onChange:d=>o(d.target.value),value:n,className:`email w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${S?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,type:"email",placeholder:"Email"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${S?"invisible opacity-0":"visible opacity-100"}`,children:"Please enter a valid email address"})]}),e.jsx("div",{className:"voucher relative col-span-full",children:e.jsx("input",{name:"voucher",onChange:d=>x(d.target.value),value:m,className:"voucher w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30",type:"voucher",placeholder:"Vourcher Code"})})]}),e.jsx("div",{className:"proceed flex justify-center items-center mt-5",children:e.jsx("button",{onClick:d=>oe(d),className:"py-2.5 px-16 transition-all duration-300 rounded-3xl font-Montserrat font-semibold glowing-btn max-w-[12rem] cursor-pointer",children:"Proceed payment"})})]}),e.jsx("div",{className:"cross",onClick:()=>i(!1),children:e.jsx(pe,{className:"absolute cursor-pointer text-xl sm:text-2xl text-dim-gray right-4 md:right-6 top-4 md:top-6"})})]})]})]})}function Ne(){return e.jsxs("section",{className:"prices relative pt-20 sm:pt-32",children:[e.jsx("div",{className:"border-b border-slate-400/10 left-1/2 transform -translate-x-1/2 absolute w-[80vw] m-auto -mt-10 sm:-mt-16"}),e.jsx("div",{className:"container relative z-10",children:e.jsx("div",{className:"wrapper relative z-20 grid 2xl:px-36",children:e.jsxs("div",{className:"heading flex flex-col sm:text-center",children:[e.jsx("h2",{className:"text-2xl xs:text-[1.7rem] text-wht-gradient",children:"Get Funded Now"}),e.jsx("p",{className:"mt-2 hidden sm:block",children:"Choose your favorite account size, start trading, earn profit-splits and scale."}),e.jsxs("p",{className:"sm:hidden mt-2 ml-5 relative before:absolute before:w-2 before:h-2 before:bg-white before:left-[-1rem] before:rounded-full before:top-1/2 before:transform before:-translate-y-1/2",children:[" ",e.jsx("b",{className:"font-bold",children:"Step 1:"})," Choose your balance:"]})]})})}),e.jsx("div",{className:"wrap sm:max-w-[70rem] px-[1.5rem] md:px-0 sm:w-full sm:m-auto sm:pt-4 overflow-hidden",children:e.jsx(je,{})}),e.jsx("div",{className:"circle-shadow hidden sm:grid justify-end absolute opacity-[40%] -top-[50%] -right-0 w-full h-full max-w-[50rem]",children:e.jsx("img",{className:"w-full",src:P,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow sm:hidden absolute grid justify-end items-end opacity-[33%] bottom-0 -top-[40%] rotate-180 left-0 w-full h-full max-w-[40rem]",children:e.jsx("img",{src:P,alt:"circle-shadow"})})]})}function j(){const[a,i]=t.useState(!1),[n,o]=t.useState(window.pageYOffset),[s,c]=t.useState(!0);window.onscroll=function(){const m=window.pageYOffset;n>m?c(!0):c(!1),n<=1&&c(!0),o(m)};const{pathname:h}=T();t.useEffect(()=>{window.scrollTo(0,0)},[h]);const u=()=>{navigator.clipboard.writeText("LAUNCH20")};return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"uni-bg-gradient fixed left-0 right-0 z-[9999] bg-black",children:e.jsxs("div",{onClick:u,className:"container text-[0.8rem] sm:text-base md:text-lg !py-4 px-3 text-center text-white flex justify-center font-Montserrat sm:cursor-pointer",children:[e.jsxs("span",{className:"font-bold px-1.5 font-Montserrat text-[0.8rem] sm:text-base md:text-lg",children:[" ","20% OFF"," "]}),"LAUNCH PROMO -",e.jsx("span",{className:"font-bold px-1.5 font-Montserrat text-[0.8rem] sm:text-base md:text-lg",children:'"LAUNCH20"'})]})}),e.jsx("header",{className:`uppercase transition-all duration-300 border-b border-transparent fpy-3 pb-3 fixed z-[999] left-0 right-0 ftop-0 top-[3.2rem] pt-2 bg-black/60 shadow-2xl backdrop-blur-3xl transform ${s?"translate-y-0":"-translate-y-[140px]"}`,children:e.jsx("div",{className:"container pt-3",children:e.jsxs("div",{className:"wrapper flex justify-between z-[999]",children:[e.jsx(p,{to:"/",className:"main-logo",children:e.jsx("img",{className:"max-w-[8rem] sm:max-w-[10rem]",src:$,alt:"TheFundedHub"})}),e.jsxs("nav",{className:"nav-links text-wht font-light flex justify-center items-center",children:[e.jsxs("ul",{className:"hidden md:flex gap-6 justify-center items-center text-sm",children:[e.jsx("li",{children:e.jsx(p,{to:"/blog",className:`flex font-Montserrat font-semibold border-b border-transparent hover:text-white transition-all duration-300 ${h==="/blog"?"text-white":"text-white/40"}`,children:"BLOG"})}),e.jsx("li",{children:e.jsx(p,{to:"/faq",className:`flex font-Montserrat font-semibold border-b border-transparent hover:text-white transition-all duration-300 ${h==="/faq"?"text-white":"text-white/40"}`,children:"FAQ"})}),e.jsx("li",{children:e.jsx(p,{to:"/contact-us",className:`flex relative group font-Montserrat font-semibold border-b border-transparent fhover:text-white transition-all duration-300 ${h==="/contact-us"?"text-white":"text-white/40"}`,children:"CONTACT US"})}),e.jsx("li",{className:"relative",children:e.jsx("a",{href:"https://dashboard.thefundedhub.com/",className:"bg-primary/20 md:bg-transparent flex justify-center items-center py-2.5 px-7 sm:px-12 hover:text-white/70 text-white transition-all duration-200 rounded-3xl whitespace-nowrap font-Montserrat font-semibold text-[0.9rem] w-full glowing-btn uppercase pb-[0.725rem]",children:"Personal Hub Login"})})]}),e.jsx("div",{className:"menu-bar md:hidden",children:e.jsx("svg",{onClick:()=>i(!a),stroke:"currentColor",fill:"currentColor",strokeWidth:"0",viewBox:"0 0 1024 1024",height:"1.8em",width:"1.8em",xmlns:"http://www.w3.org/2000/svg",children:e.jsx("path",{d:"M904 160H120c-4.4 0-8 3.6-8 8v64c0 4.4 3.6 8 8 8h784c4.4 0 8-3.6 8-8v-64c0-4.4-3.6-8-8-8zm0 624H120c-4.4 0-8 3.6-8 8v64c0 4.4 3.6 8 8 8h784c4.4 0 8-3.6 8-8v-64c0-4.4-3.6-8-8-8zm0-312H120c-4.4 0-8 3.6-8 8v64c0 4.4 3.6 8 8 8h784c4.4 0 8-3.6 8-8v-64c0-4.4-3.6-8-8-8z"})})})]})]})})}),e.jsxs("div",{className:"mobile-nav z-[9999] relative uppercase",children:[e.jsx("svg",{onClick:()=>i(!1),className:`text-wht fixed right-[5%] top-8 z-[88] transition-all duration-500 ${a?"opacity-100 rotate-180 visible":"opacity-0 invisible"}`,stroke:"currentColor",fill:"none",strokeWidth:"0",viewBox:"0 0 15 15",height:"2.2em",width:"2.2em",xmlns:"http://www.w3.org/2000/svg",children:e.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z",fill:"currentColor"})}),e.jsx("div",{onClick:()=>i(!1),className:`darkbg fixed inset-0 bg-main-bg/20 bottom-0  backdrop-blur-xl z-[77] transition-all duration-500 ${a?"opacity-100 visible":"opacity-0 invisible"}`}),e.jsx("nav",{className:`mobile-nav md:hidden fixed top-0 bottom-0 w-[80%] xs:w-[70%] sm:w-[60%] bg-main-bg/30 z-[99] transition-all duration-500 ${a?"left-0 opacity-100":"-left-full opacity-0"}`,children:e.jsxs("div",{className:"wrapper",children:[e.jsx(p,{to:"/",className:"logo block pt-6 px-6",children:e.jsx("img",{className:"max-w-[10rem] w-full md:hidden",src:$,alt:"TheFundedHub"})}),e.jsxs("ul",{className:"flex flex-col justify-start text-sm mt-6",children:[e.jsx("li",{children:e.jsx(p,{to:"/blog",className:"flex font-Montserrat py-3 pl-6 w-full font-semibold border-y border-light/30 transition-all duration-300",children:"Blog"})}),e.jsx("li",{children:e.jsx(p,{to:"/faq",className:"flex font-Montserrat py-3 pl-6 w-full font-semibold border-b border-light/30 transition-all duration-300",children:"FAQ"})}),e.jsx("li",{children:e.jsx(p,{to:"/contact-us",className:"flex font-Montserrat py-3 pl-6 w-full font-semibold border-b border-light/30 transition-all duration-300",children:"Contact Us"})}),e.jsx("li",{className:"flex mt-4 pl-6",children:e.jsx("a",{href:"https://dashboard.thefundedhub.com/",className:"flex justify-center items-center font-Montserrat font-semibold rounded-3xl w-56 h-10 glowing-btn uppercase text-sm",children:"Personal Hub Login"})})]})]})})]})]})}const ke=[{name:"PHASE 1",content:`<p>
        ...
        potential rewards.
                  ...
                  `,src:Fe,alt:"instagram"})}),e.jsxs("div",{className:"w-full grid justify-center gap-3",children:[e.jsx("p",{className:"text-center",children:"Trading is certainly not easy! Interact with other traders and discuss about the markets, strategies and stay up to date with all the TFH official announcements."}),e.jsx("div",{className:"mt-4 btn uppercase flex justify-center",children:e.jsx("a",{target:"__blank",href:"https://www.instagram.com/fundedhub/",className:"uppercase font-base flex h-full justify-center items-center py-3 px-10 text-white border-primary rounded-3xl whitespace-nowrap font-Montserrat font-semibold text-[0.8rem] max-w-[228px] insta-glowing-btn",children:"Join us on Instagram"})})]})]})]})]}),e.jsx("div",{className:"circle-shadow hidden sm:block absolute opacity-[40%] -top-[60%] -left-[50%] w-full h-full sm:min-w-[50rem]",children:e.jsx("img",{className:"w-full",src:F,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow sm:hidden absolute grid justify-end items-end opacity-[40%] bottom-0 -top-[30%] right-0 w-full h-full max-w-[40rem]",children:e.jsx("img",{src:P,alt:"circle-shadow"})})]})}const Ee="/assets/x-a3a9855d.webp",Ie="/assets/discord-b0b80765.webp",Pe="/assets/instagram-3e95cfc6.webp";function W(){return e.jsxs("div",{className:"logos flex gap-4",children:[e.jsx("a",{target:"__blank",href:"https://www.instagram.com/fundedhub/",className:"w-[1.5rem] hover:opacity-70 transition-all duration-300 flex justify-center items-center",children:e.jsx("img",{className:"w-full",src:Pe,alt:"Instagram"})}),e.jsx("a",{target:"__blank",href:"https://twitter.com/TheFundedHub",className:"logo w-[1.5rem] hover:opacity-70 transition-all duration-300 flex justify-center items-center",children:e.jsx("img",{className:"w-full",src:Ee,alt:"X"})}),e.jsx("a",{target:"__blank",href:"https://discord.gg/thefundedhub",className:"logo w-[1.9rem] hover:opacity-70 transition-all duration-300 flex justify-center items-center",children:e.jsx("img",{className:"w-full",src:Ie,alt:"discord"})})]})}function N(){const[a,i]=t.useState(""),{pathname:n}=T();return t.useEffect(()=>{i(n)},[]),e.jsx("footer",{className:"footer relative body-background pt-6 pb-5 z-40",children:e.jsxs("div",{className:"container relative z-10",children:[e.jsxs("div",{className:"footer-desktop hidden lg:grid gap-10",children:[e.jsxs("div",{className:"top flex justify-between",children:[e.jsx("div",{className:"left ",children:e.jsx(p,{to:"/",className:"main-logo flex gap-1",children:e.jsx("img",{className:"max-w-[10rem]",src:$,alt:"TheFundedHub"})})}),e.jsx("div",{className:"middle grid gap-6 justify-end items-center",children:e.jsx("div",{className:"item flex justify-center items-center",children:e.jsxs("ul",{className:"flex font-Montserrat font-medium gap-4 flex-wrap md:flex-nowrap",children:[e.jsx("li",{children:e.jsx(p,{onClick:()=>i("/terms-condition"),to:"/terms-condition",className:`text-sm  hover:text-white transition-all duration-300 ${a==="/terms-condition"?"text-white":"text-white/40"}`,children:"Terms and Condition"})}),e.jsx("li",{children:e.jsx(p,{onClick:()=>i("/privacy-policy"),to:"/privacy-policy",className:`text-sm  hover:text-white transition-all duration-300 ${a==="/privacy-policy"?"text-white":"text-white/40"}`,children:"Privacy Policy"})}),e.jsx("li",{children:e.jsx(p,{onClick:()=>i("/cookie-policy"),to:"/cookie-policy",className:`text-sm  hover:text-white transition-all duration-300 ${a==="/cookie-policy"?"text-white":"text-white/40"}`,children:"Cookie Policy"})}),e.jsx("li",{children:e.jsx(p,{onClick:()=>i("/risk-disclosure"),to:"/risk-disclosure",className:`text-sm  hover:text-white transition-all duration-300 ${a==="/risk-disclosure"?"text-white":"text-white/40"}`,children:"Risk Disclosure"})}),e.jsx("li",{children:e.jsx(p,{onClick:()=>i("/report-problem"),to:"/report-problem",className:`text-sm relative group hover:text-white transition-all duration-300  ${a==="/report-problem"?"text-white":"text-white/40"}`,children:"Report a problem"})})]})})}),e.jsx("div",{className:"right",children:e.jsx(W,{})})]}),e.jsx("div",{className:"bottom",children:e.jsx("div",{className:"hidden sm:block bottom-content text-center",children:e.jsx("p",{className:"text-[0.65rem] font-light mt-2",children:"The Funded Hub is a brand owned by THE FUNDED HUB GLOBAL LLP. All information available on this site is intended solely for the study purposes related to trading on financial markets and does not serve in any way as a specific investment recommendation, business recommendation, investment opportunity analysis or similar general recommendation regarding the trading of investment instruments. Trading in financial markets is a high-risk activity and it is advised not to risk more than one can afford to lose! THE FUNDED HUB GLOBAL LLP does not provide any of the investment services listed in the Capital Market Undertakings Act No. 256/2004 Coll. The information on this site is not directed at residents in any country or jurisdiction where such distribution or use would be contrary to local laws or regulations. Either The Funded Hub and THE FUNDED HUB GLOBAL LLP is not a broker and do not accept deposits. The offered technical solution for the The Funded Hub MT5 platforms and data feed are powered by our institutional liquidity providers."})})})]}),e.jsxs("div",{className:"footer-mobile grid gap-6 lg:hidden",children:[e.jsxs("div",{className:"flex justify-between gap-4",children:[e.jsx("div",{className:"logo flex justify-center items-center",children:e.jsx(p,{to:"/",className:"main-logo flex gap-1",children:e.jsx("img",{className:"max-w-[8rem]",src:$,alt:"TheFundedHub"})})}),e.jsx(W,{})]}),e.jsxs("div",{className:"content grid gap-8 mt-4",children:[e.jsx("div",{className:"top",children:e.jsx("div",{className:"items gap-4",children:e.jsx("div",{className:"item grid justify-center items-center",children:e.jsxs("ul",{className:"flex flex-wrap gap-4 justify-center items-center",children:[e.jsx("li",{children:e.jsx(p,{onClick:()=>i("/terms-condition"),to:"/terms-condition",className:` ${a==="/terms-condition"?"text-white":"text-white/40"} hover:text-white`,children:"Term and Condition"})}),e.jsx("li",{children:e.jsx(p,{onClick:()=>i("/privacy-policy"),to:"/privacy-policy",className:` ${a==="/privacy-policy"?"text-white":"text-white/40"} hover:text-white`,children:"Privacy Policy"})}),e.jsx("li",{children:e.jsx(p,{onClick:()=>i("/ookie-policy"),to:"/cookie-policy",className:` ${a==="/cookie-policy"?"text-white":"text-white/40"} hover:text-white`,children:"Cookie Policy"})}),e.jsx("li",{children:e.jsx(p,{onClick:()=>i("/risk-disclosure"),to:"/risk-disclosure",className:` ${a==="/risk-disclosure"?"text-white":"text-white/40"} hover:text-white`,children:"Risk Disclosure"})}),e.jsx("li",{children:e.jsx(p,{onClick:()=>i("/report-problem"),to:"/report-problem",className:` relative group ${a==="/report-problem"?"text-white":"text-white/40"} fhover:text-white`,children:"Report a problem"})})]})})})}),e.jsx("div",{className:"bottom text-center",children:e.jsx("p",{className:"text-[0.65rem] font-light mt-2",children:"The Funded Hub is a brand owned by THE FUNDED HUB GLOBAL LLP. All information available on this site is intended solely for the study purposes related to trading on financial markets and does not serve in any way as a specific investment recommendation, business recommendation, investment opportunity analysis or similar general recommendation regarding the trading of investment instruments. Trading in financial markets is a high-risk activity and it is advised not to risk more than one can afford to lose! THE FUNDED HUB GLOBAL LLP does not provide any of the investment services listed in the Capital Market Undertakings Act No. 256/2004 Coll. The information on this site is not directed at residents in any country or jurisdiction where such distribution or use would be contrary to local laws or regulations. Either The Funded Hub and THE FUNDED HUB GLOBAL LLP is not a broker and do not accept deposits. The offered technical solution for the The Funded Hub MT5 platforms and data feed are powered by our institutional liquidity providers."})})]})]})]})})}const He="/assets/select-e68781a8.png",Le="/assets/BlackBull-logo-ce4aa3ed.png",Oe="/assets/klarna-after-pay-0bcee81f.png",Me=[{name:"<span>CRAFT</span> YOUR CHALLENGE",img:He,content:`<p>
                    ...
                    drawdown.
                  </p>`},{name:"<span>REGUALATED</span> BROKER",img:Le,content:`<p>
                Our traders deserve the best, only! We're thrilled to be
                partnering with BlackBull to offer you the best trading
                conditions in the market.
              </p>`},{name:"PAY IN 3 <span>INSTALLMENT</span>",img:Oe,content:`<p>
                Don&lsquo;t wait to succeed! Split your challenge payment
                into 3/4 installments for ultimate flexibility. Join us
                today!
              </p>`}],Q=["5,000","10,000","25,000","50,000","100,000","200,000"],De=["$50","$100","$250","$500","$1,000","$2,000"];function Re({setOpenFaq:a}){const[i,n]=t.useState(5);return e.jsxs("section",{className:"benefits relative md:m-auto pt-20 sm:pt-24",children:[e.jsx("div",{className:"container",children:e.jsxs("div",{className:"wrapper grid gap-6 relative z-30",children:[e.jsxs("div",{className:"heading z-10 relative flex flex-col justify-center sm:items-center sm:text-center",children:[e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.7rem] tracking-tight text-wht-gradient",children:"The Funded Hub Benefits"}),e.jsx("div",{className:"paras mt-2 max-w-[55rem]",children:e.jsx("p",{children:"We are partnering up directly with a regulated liquidity provider to offer you unbeatable trading conditions. Our accounts will let you trade in an excellent environment with tight spreads and lighting-fast execution."})})]}),e.jsxs("div",{className:"wrapper max-w-[25rem] sm:max-w-[45rem] lg:max-w-[70rem] m-auto grid gap-12",children:[e.jsx("div",{className:"cards grid auto-rows-fr sm:grid-cols-2 lg:grid-cols-3 gap-6",children:Me.map((o,s)=>e.jsx("div",{className:"card-border card-border-gradient p-[0.2rem] rounded-3xl card-shadow sticky top-20 sm:top-0 sm:relative",children:e.jsxs("div",{className:"card relative uni-bg-gradient p-3 rounded-3xl h-full flex flex-col gap-5",children:[e.jsx("div",{className:"header card-header-gradient rounded-2xl p-[0.25rem] card-header-shadow",children:e.jsx("h4",{className:"bg-black py-3 px-4 rounded-2xl",dangerouslySetInnerHTML:{__html:o.name}})}),e.jsx("div",{className:"img min-h-[80px] px-4 w-full flex justify-center items-center",children:e.jsx("img",{className:`w-[15rem] ${s===1?"w-[14rem]":s===2?"w-[20rem]":""}`,src:o.img,alt:"select-img"})}),e.jsxs("div",{className:"benefit-content flex flex-col justify-between h-full",children:[e.jsx("div",{className:"px-4",dangerouslySetInnerHTML:{__html:o.content}}),e.jsx("div",{className:`readmore px-4 ${s!==2&&"hidden"}`,children:e.jsx("a",{onClick:()=>a(!0),href:"#klarna-afterpay",className:"text-[#65749F] font-bold text-[1rem] underline",children:"Coming soon"})}),e.jsx("div",{className:"btn flex justify-start py-2 px-4",children:e.jsx("a",{href:"#price-table",className:"p-3 px-10 rounded-3xl text-[0.9rem] font-Montserrat font-bold uppercase home-glowing-btn text-start",children:"Get Funded Now"})})]})]})},s))}),e.jsx("div",{className:"fixed-border relative fixed-border-gradient rounded-3xl card-shadow",children:e.jsxs("div",{className:"fixed-salary relative uni-bg-gradient px-8 py-4 rounded-3xl grid gap-4",children:[e.jsx("div",{className:"name card-header-gradient relative card-shadow  rounded-2xl p-1 max-w-[17rem]",children:e.jsxs("h4",{className:"bg-black py-3 px-4 rounded-2xl pl-4",children:[" ","EARN A ",e.jsx("span",{children:"FIXED SALARY"})]})}),e.jsx("p",{children:"Earn a monthly salary as soon as you qualify for the scaling plan, bringing you closer to your dream of becoming a full-time trader. All the funded traders who successfully complete Challenge Phases 1 & 2 and receive a live funded account are eligible for a Monthly Salary, provided they meet certain conditions."}),e.jsx("div",{className:"fixed-btns pb-4 max-w-[40rem] sm:max-w-none overflow-x-scroll sm:overflow-hidden flex sm:grid sm:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-2",children:Q.map((o,s)=>e.jsx("div",{onClick:()=>n(s),className:"btn-border p-[0.1rem] w-full rounded-2xl",children:e.jsxs("button",{className:`py-2 px-4 xs:px-10  w-full text-base rounded-2xl ${Q[i]===o?"bg-[#65749F]":"bg-[#12151E]"}`,children:["$",o]})},s))}),e.jsx("div",{className:"bottom flex justify-center xs:gap-6 items-center",children:e.jsx("div",{className:"price-change-btnf rounded-2xl p-[0.25rem] xs:w-[18rem] ",children:e.jsxs("h4",{className:"bg-[#12151E] grid sm:flex gap-2 justify-center items-center py-3 sm:py-5 px-6 sm:px-12 xs:pl-2 xs:whitespace-nowrap rounded-2xl text-sm sm:text-[0.9rem] text-center sm:text-start",children:[e.jsx("span",{className:"text-[1.4rem] inline-block",children:De[i]})," ",e.jsx("span",{className:"hidden sm:inline-block",children:" / "})," ","Monthly Salary"]})})})]})})]})]})}),e.jsx("div",{className:"circle-shadow hidden sm:block absolute opacity-[40%] -top-[10%] -left-[35%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:F,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow sm:hidden absolute grid justify-end items-end opacity-[33%] bottom-0 -top-[30%] right-0 w-full h-full max-w-[40rem]",children:e.jsx("img",{src:P,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow sm:hidden absolute grid justify-end items-end opacity-[40%] bottom-0 -top-[40%] rotate-180 left-0 w-full h-full max-w-[40rem]",children:e.jsx("img",{src:P,alt:"circle-shadow"})})]})}const ee="/assets/hero-mockup-2fafe627.webp";function qe(){return e.jsx("main",{className:"hero relative pt-32 md:pt-40  pb-20 lg:px-[2rem] ",children:e.jsx("div",{className:"container relative",children:e.jsxs("div",{className:"wrapper  z-10 fxs:pt-24 pt-12 fmd:pt-28 relative grid lg:grid-cols-2 md:gap-4 ",children:[e.jsxs("div",{className:"left-content flex flex-col gap-4 justify-center w-full relative font-Montserrat text-right",children:[e.jsxs("div",{className:"title text-start lg:text-end md:-translate-y-8",children:[e.jsxs("h1",{className:"text-[1.7rem] sm:text-4xl md:text-5xl lg:text-4xl xl:text-[3.13rem] font-light uppercase text-wht-gradient",children:[e.jsx("div",{className:"font-bold text-[inherit] inline-block",children:"Empowering"})," ","Traders"]}),e.jsxs("h2",{className:"text-[#495363] tracking-tighter leading-[0.95] font-black text-[3.5rem] sm:text-4xl md:text-5xl lg:text-6xl  xl:text-[6.5rem] shadow-text",children:["One step at ",e.jsx("br",{})," a time."]})]}),e.jsx("div",{className:"mobile-img md:hidden py-4",children:e.jsx("div",{className:"mockup",children:e.jsx("img",{src:ee,alt:"mobile-mockup",className:"w-full"})})}),e.jsxs("div",{className:"wrap grid gap-4 text-start lg:text-end font-normal",children:[e.jsxs("div",{className:"wrap ",children:[e.jsx("p",{children:"Customize your challenge, get funded with our capital and earn"}),e.jsx("p",{className:"text-start lg:text-end",children:"up to 90% profit split plus a fixed monthly salary."}),e.jsx("p",{className:"text-start lg:text-end",children:"We take all the trading risks."})]}),e.jsxs("div",{className:"btns flex flex-col md:flex-row lg:justify-end gap-4 sm:gap-8",children:[e.jsx("div",{className:"btn flex font-extrabold",children:e.jsx("a",{href:"#price-table",className:`home-glowing-btn transition-all\r
                     duration-200 hover:scale-[1.05] py-[0.8rem] px-12 rounded-full uppercase max-w-[270px] w-full`,children:"Get Funded Now"})}),e.jsx("div",{className:"btn flex font-extrabold",children:e.jsx("a",{target:"__blank",href:"https://discord.gg/thefundedhub",className:"uppercase hero-blue-bnt before:py-6 md:before:py-5 px-12 relative flex justify-center items-center transition-all text-center duration-200 hover:scale-[1.05] w-[270px] py-7 md:py-6",children:e.jsx("span",{className:"absolute left-0 right-0 top-1/2 transform -translate-y-1/2",children:"Join our Discord"})})})]})]})]}),e.jsx("div",{className:"right-content hidden md:flex justify-end sm:mt-4 md:mt-10 ml-12",children:e.jsx("div",{className:"mockup",children:e.jsx("img",{src:ee,alt:""})})})]})})})}function $e({heading:a,para:i,openFaq:n,i:o}){const[s,c]=t.useState(0),[h,u]=t.useState(!1),m=t.useRef(null);return t.useEffect(()=>{c(m.current.clientHeight)},[h]),t.useEffect(()=>{n&&o===3&&u(!0)},[n]),e.jsxs("article",{id:`${o===3&&"klarna-afterpay"}`,className:"border border-primary/[15%] rounded-2xl",children:[e.jsxs("header",{onClick:()=>u(!h),className:"flex justify-between cursor-pointer py-3 px-4",children:[e.jsx("h3",{className:"text-[0.9rem] xs:text-base",children:a}),e.jsx("div",{className:"arrow flex justify-center items-center ml-3",children:e.jsx("img",{className:`max-w-[1.2rem] transform-gpu transition-all duration-300 ${h?"rotate-180":""}`,src:w,alt:"arrow"})})]}),e.jsx("div",{style:{maxHeight:h?s+"px":"0"},className:"content transition-all duration-300 overflow-hidden",children:e.jsx("div",{ref:m,className:"faq-collaps mt-2 text-[0.9rem] xs:text-base pb-6 px-4 grid gap-4",dangerouslySetInnerHTML:{__html:i}})})]})}function We({openFaq:a}){const i=[{name:"Empowering Traders, one step at a time",data:`<p>
     ...
     <p>
      ...
      <p>
        ...
        article directly following this one.
            ...
            </div>`}];return e.jsxs("section",{className:"home-faq relative pt-28 overflow-hidden",children:[e.jsx("div",{className:"border-b border-slate-400/10 left-1/2 transform -translate-x-1/2 absolute w-[80vw] m-auto  -mt-14"}),e.jsx("div",{className:"container relative z-10",children:e.jsxs("div",{className:"wrapper grid gap-8 justify-center items-center",children:[e.jsxs("div",{className:"heading flex flex-col gap-2 justify-center items-center text-center",children:[e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.7rem] tracking-tight text-wht-gradient",children:"FAQ"}),e.jsx("div",{className:"paras",children:e.jsxs("p",{children:["If you don't find an answer in the frequently asked questions don't hesitate to"," ",e.jsx(p,{to:"/contact",className:"underline font-semibold",children:"contact us"})]})})]}),e.jsx("div",{className:"articles md:max-w-[60rem] m-auto grid gap-5",children:i.map((n,o)=>e.jsx($e,{heading:n.name,para:n.data,openFaq:a,i:o},o))}),e.jsx("div",{className:"readmore flex justify-center mb-12 xs:mb-24 md:mb-32",children:e.jsx(p,{to:"faq",className:"text-xs x:text-sm font-bold py-2 px-10 border-2 border-primary/20 rounded-3xl",children:"Visit FAQ Page"})})]})}),e.jsx("div",{className:"circle-shadow absolute grid justify-end items-end opacity-[23%] bottom-0 right-0 w-full h-full max-w-[40rem]",children:e.jsx("img",{src:P,alt:"circle-shadow"})})]})}function ze(){const{pathname:a}=T(),[i,n]=t.useState(!1);return t.useEffect(()=>{window.scrollTo(0,0)},[a]),e.jsxs("div",{className:"font-light",children:[e.jsx(j,{}),e.jsx(qe,{}),e.jsx(Te,{}),e.jsx(Re,{setOpenFaq:n}),e.jsx(Ne,{}),e.jsx(Ae,{}),e.jsx(We,{openFaq:i}),e.jsx(N,{}),e.jsx("div",{className:"hidden h-0 w-0 opacity-0 left-0 visible md:invisible"}),e.jsx("script",{src:"./js/script.js"})]})}function ie({clr:a,header:i}){const[n,o]=t.useState(""),[s,c]=t.useState(""),[h,u]=t.useState(""),[m,x]=t.useState(""),[g,I]=t.useState(""),[S,E]=t.useState(""),[v,L]=t.useState(!0),[r,y]=t.useState(!0),[C,O]=t.useState(!1);t.useEffect(()=>{/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(h)&&h!==""?y(!0):C&&y(!1)},[h,v]);const A=()=>{n&&s&&r&&m&&g!==""?q.post("https://api.thefundedhub.com/v1/website/questions",{firstName:n,lastName:s,email:h,subject:m,message:g}).then(f=>{E("success"),o(""),c(""),u(""),x(""),I(""),L(!0),y(!0)}).catch(f=>{E("failed")}):(L(!1),O(!0))},M=f=>{f.preventDefault(),A(),E("")};return e.jsxs(e.Fragment,{children:[e.jsxs("form",{className:`grid gap-6 sm:gap-8 md:gap-10 px-4 py-6 sm:p-8 relative z-10 rounded-3xl border-primary backdrop-blur-3xl global-shadow  ${a==="dash-bar-clr"?"contact-clr":"uni-bg-gradient"}`,children:[e.jsx("div",{className:"head",children:e.jsx("h3",{className:"text-xl",children:i||"Have questions?"})}),e.jsxs("div",{className:"inputs grid sm:grid-cols-2 gap-7",children:[e.jsxs("div",{className:"name relative",children:[e.jsx("input",{name:"name",onChange:f=>o(f.target.value),required:!0,className:`name w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${v||n!==""?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,type:"text",value:n,placeholder:"Name"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${v||n!==""?"invisible opacity-0":"visible opacity-100"}`,children:"This field is required"})]}),e.jsxs("div",{className:"surname relative",children:[e.jsx("input",{name:"surname",onChange:f=>c(f.target.value),value:s,className:`lastName w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${v||n!==""?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,placeholder:"Surname"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${v||s!==""?"invisible opacity-0":"visible opacity-100"}`,children:"This field is required"})]}),e.jsxs("div",{className:"email relative",children:[e.jsx("input",{name:"email",required:!0,onChange:f=>u(f.target.value),value:h,className:`email w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${r?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,type:"email",placeholder:"Email"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${r?"invisible opacity-0":"visible opacity-100"}`,children:"Please enter a valid email address"})]}),e.jsxs("div",{className:"subject relative",children:[e.jsx("input",{name:"subject",required:!0,onChange:f=>x(f.target.value),value:m,className:`subject w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${v||m!==""?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,type:"text",placeholder:"Subject"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${v||m!==""?"invisible opacity-0":"visible opacity-100"}`,children:"This field is required"})]})]}),e.jsxs("div",{className:"textarea relative",children:[e.jsx("textarea",{onChange:f=>I(f.target.value),required:!0,value:g,className:`bg-transparent backdrop-blur-3xl border-none outline outline-2 p-4 rounded-xl transition-all duration-200 w-full min-h-[10rem] sm:min-h-[12rem] md:min-h-[15rem] ${v||g!==""?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,name:"message",id:"message",placeholder:"Comment"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1rem] text-red-600 text-[0.66rem] ${v||g!==""?"invisible opacity-0":"visible opacity-100"}`,children:"This field is required"})]}),e.jsx("div",{className:"login-btn flex justify-center items-center",children:e.jsx("button",{onClick:f=>M(f),className:"py-2.5 px-16 transition-all duration-300 rounded-3xl font-Montserrat font-semibold glowing-btn max-w-[12rem] cursor-pointer",children:"Send"})})]}),e.jsx("div",{className:`box  fixed z-[999999] top-[30%] transform -translate-y-1/2 -right-[3rem] lg:-right-[4rem]  text-main text-wht bg-light-gra transition-all border border-primary/10 backdrop-blur-3xl duration-300 rounded-l-full my-3 overflow-hidden p-3 sm:p-5 px-12 md:w-[30rem] text-center ${S==="success"?" bg-[#08be00] contact-send-popup":S==="failed"?"bg-red-600 contact-send-popup":"invisible opacity-0"}`,children:e.jsx("div",{className:"subscribe text-base sm:text-xl font-nomal text-center pr-[1.5rem]",children:S==="success"?e.jsx("div",{children:"Message Sent!"}):S==="failed"?e.jsx("div",{children:"Sorry, please try again :("}):""})})]})}function Be(){const{pathname:a}=T();return t.useEffect(()=>{window.scrollTo(0,0)},[a]),e.jsxs(e.Fragment,{children:[e.jsx(j,{}),e.jsxs("section",{className:"contact relative pt-40 sm:pt-52 pb-28 sm:pb-44 overflow-hidden",children:[e.jsx("div",{className:"container z-10 relative",children:e.jsx("div",{className:"wrapper flex items-center justify-center w-full",children:e.jsxs("div",{className:"content grid md:grid-cols-3 gap-10 max-w-[75rem] w-full",children:[e.jsxs("div",{className:"left md:col-span-1",children:[e.jsxs("div",{className:"heading grid gap-2",children:[e.jsx("div",{className:"wrap",children:e.jsx("h3",{className:"text-3xl text-wht-gradient",children:"Contact Us"})}),e.jsxs("p",{children:["Questions? Doubts? ",e.jsx("br",{})," Please contact us anytime and our team will take care of you!"]})]}),e.jsx("div",{className:"mt-5",children:e.jsx(W,{})})]}),e.jsx("div",{className:"right md:col-span-2",children:e.jsx(ie,{})})]})})}),e.jsx("div",{className:"circle-shadow absolute opacity-[33%] -top-[10%] -left-[50%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:F,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow absolute opacity-[25%] top-[40%] -right-[20%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:F,alt:"circle-shadow"})})]}),e.jsx(N,{})]})}function Ue(){const{pathname:a}=T();return t.useEffect(()=>{window.scrollTo(0,0)},[a]),e.jsxs(e.Fragment,{children:[e.jsx(j,{}),e.jsxs("section",{className:"contact relative pb-28 pt-40 sm:pt-52 sm:pb-44 overflow-hidden",children:[e.jsx("div",{className:"container z-10 relative",children:e.jsx("div",{className:"wrapper flex items-center w-full",children:e.jsxs("div",{className:"content grid md:grid-cols-3 gap-10 max-w-[75rem] w-full m-auto",children:[e.jsxs("div",{className:"left md:col-span-1 break-all ",children:[e.jsxs("div",{className:"heading grid gap-2",children:[e.jsx("h3",{className:"text-3xl",children:"Report a Problem"}),e.jsxs("p",{children:["Did you notice any bug or technical error? ",e.jsx("br",{})," Please let us know!"]})]}),e.jsx("div",{className:"mt-5",children:e.jsx(W,{})})]}),e.jsx("div",{className:"right md:col-span-2",children:e.jsx(ie,{header:"Contact Us"})})]})})}),e.jsx("div",{className:"circle-shadow absolute opacity-[15%] -top-[70%] -left-[50%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:F,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow absolute opacity-[20%] top-[40%] -right-[20%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:F,alt:"circle-shadow"})})]}),e.jsx(N,{})]})}function Ve({heading:a,para:i,fls:n}){const[o,s]=t.useState(0),[c,h]=t.useState(n),u=t.useRef(null);return t.useEffect(()=>{s(u.current.clientHeight)},[c]),e.jsxs("article",{className:"item rounded-xl global-shadow ",children:[e.jsxs("header",{onClick:()=>h(!c),className:"flex justify-between cursor-pointer py-3 px-4",children:[e.jsx("h3",{className:"text-[0.9rem] xs:text-base font-Montserrat font-semibold",children:e.jsx("div",{dangerouslySetInnerHTML:{__html:a}})}),e.jsx("div",{className:"arrow flex justify-center items-center ml-3",children:e.jsx("img",{className:`max-w-[1.4rem] transform-gpu transition-all duration-300 ${c?"rotate-180":""}`,src:w,alt:"arrow"})})]}),e.jsx("div",{style:{maxHeight:c?o+"px":"0"},className:"faq-content transition-all duration-300 overflow-hidden ",children:e.jsx("div",{ref:u,className:"wrapper",children:e.jsx("div",{className:"text-[0.9rem] xs:text-base px-4 pb-5 pt-4 border-t border-primary/20",children:e.jsx("div",{className:"faq-collaps",dangerouslySetInnerHTML:{__html:i}})})})})]})}let Ye={General:[{name:"The Funded Hub: Empowering Traders, one step at a time",data:`<div className="paras">
              <p>
...
`},{link:"blog-5",img:"",title:"Introduction to Forex Trading with The Funded Hub: A Beginner's Guide",para:`<span></span> Explore the power of leverage
          ...
          `},{link:"blog-12",img:"",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function ea(){let[a,i]=t.useState(1);const n=6,o=Math.ceil(U.length/n),s=Qe(U,n),c=(u,m)=>{i(m),s.jump(m)},h=ye({palette:{mode:"dark"}});return e.jsxs(e.Fragment,{children:[e.jsx(j,{}),e.jsxs("section",{className:"blog relative pt-36 sm:pt-48 pb-28 sm:pb-44 overflow-hidden",children:[e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"header flex justify-between w-full",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.7rem] tracking-tight text-wht-gradient",children:"Blog"})}),e.jsx("div",{className:"blogs mt-12 grid sm:grid-cols-2 md:grid-cols-3 gap-6 relative",children:s.currentData().map((u,m)=>e.jsxs(p,{to:`/blog/${u.link}`,className:"single-blog p-[0.9rem] bg-light/20 backdrop-blur-3xl rounded-xl !relative global-shadow grid justify-between items-end gap-4",children:[e.jsx("div",{className:"blog-img rounded-md hidden",children:e.jsx("img",{className:"rounded-md w-full h-full leading-none",src:u.img,alt:u.alt})}),e.jsxs("div",{className:"texts fmt-6 grid gap-3 pb-8",children:[e.jsx("h3",{className:"font-semibold",children:u.title}),e.jsx("div",{className:"blog-para-slice",children:e.jsx("p",{dangerouslySetInnerHTML:{__html:u.para.slice(0,140)+"...."}})}),e.jsx("div",{className:"date text-sm absolute bottom-3",children:u.date})]})]},u.title+m))}),e.jsx("div",{className:"pagination mt-10 flex justify-center",children:e.jsx(xe,{theme:h,children:e.jsx(ve,{spacing:2,children:e.jsx(be,{count:o,page:a,shape:"rounded",variant:"outlined",color:"secondary",onChange:c})})})})]})}),e.jsx("div",{className:"circle-shadow absolute opacity-[23%] -top-[10%] -left-[50%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:F,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow absolute opacity-[25%] top-[40%] -right-[20%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:F,alt:"circle-shadow"})})]}),e.jsx(N,{})]})}function aa(){const{pathname:a}=T(),i=U.filter(({link:n})=>n===a.slice(6));return e.jsxs(e.Fragment,{children:[e.jsx(j,{}),e.jsx("section",{className:"single-blog relative pt-16f pt-24 sm:pt-20 pb-28 sm:pb-44 overflow-hidden",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"flex justify-center items-center blog-content",children:e.jsx("div",{className:"blog-img p-[0.03rem] rounded-md",children:e.jsx("img",{className:"rounded-md",src:"",alt:i.alt})})}),e.jsxs("div",{className:"blog-content ",children:[e.jsx("div",{className:"heading",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.9rem] tracking-tight text-wht-gradient",children:i[0].title})}),e.jsxs("div",{className:"blog-wrap-data global-shadow",children:[e.jsx("div",{className:"data ",dangerouslySetInnerHTML:{__html:i[0].data}}),e.jsx("div",{className:"btn mt-10 m-auto max-w-[17rem]",children:e.jsx(p,{link:"/#price-table",className:"uppercase font-Montserrat text-sm font-semibold  transition-all duration-200 glowing-btn",children:"Get Funded Now"})})]})]})]})})}),e.jsx(N,{})]})}function ta(){return e.jsxs(e.Fragment,{children:[e.jsx(j,{}),e.jsx("section",{className:"relative purple-shadow h-[450px] md:h-[550px] lg:h-[650px]",children:e.jsx("div",{className:"container z-10 relative h-full",children:e.jsxs("div",{className:"wrapper h-full flex flex-col gap-4 justify-center items-center text-center text-2xl sm:text-3xl md:text-[2rem] lg:text-4xl",children:[e.jsx("h1",{children:"Sorry, your payment is unsuccessful :("}),e.jsx("h1",{className:"text-3xl text-primary",children:"Please try again"})]})})}),e.jsx(N,{})]})}function ia({children:a}){const[i,n]=t.useState("UNPAID"),[o,s]=t.useState(!0),[c,h]=t.useState(localStorage.getItem("purchaseUuid")),u=me();t.useEffect(()=>{h(localStorage.getItem("purchaseUuid"))},[]);const m="https://api.thefundedhub.com",g=window.location.href.split("session=")[1],I=()=>{c&&g?q.put(`${m}/v1/website/purchases/${c}`,{paymentReference:g}).then(S=>{n(S.data.data.status),s(!1),localStorage.removeItem("purchaseUuid")}).catch(()=>{s(!1)}):u("/")};return t.useEffect(()=>{setTimeout(I)},[]),o?e.jsxs("div",{className:"flex justify-center items-center h-screen flex-col gap-4",children:[e.jsx("div",{className:"loader text-primary text-4xl xs:text-5xl",children:"Loading..."}),e.jsx("div",{className:"flex justify-center items-center mt-4",children:e.jsx(we,{strokeColor:"#C7B3FC",strokeWidth:"5",animationDuration:"0.75",width:"80",visible:!0})})]}):e.jsx(e.Fragment,{children:i==="PAID"?a:e.jsx(fe,{to:"/payment-error"})})}te.initialize("G-0GFK77GQTB");te.send({hitType:"pageview",page:window.location.pathname});const ra="ef72a2fc-1672-41b9-acd5-260aac3e06ba";function sa(){return e.jsxs("div",{className:"App body-background",children:[e.jsx(ce,{children:e.jsxs(ge,{children:[e.jsx(b,{path:"/",element:e.jsx(ze,{})}),e.jsx(b,{path:"contact-us",element:e.jsx(Be,{})}),e.jsx(b,{path:"report-problem",element:e.jsx(Ue,{})}),e.jsx(b,{path:"faq",element:e.jsx(Ge,{})}),e.jsx(b,{path:"cookie-policy",element:e.jsx(Ke,{})}),e.jsx(b,{path:"privacy-policy",element:e.jsx(_e,{})}),e.jsx(b,{path:"terms-condition",element:e.jsx(Je,{})}),e.jsx(b,{path:"risk-disclosure",element:e.jsx(Xe,{})}),e.jsx(b,{path:"payment-error",element:e.jsx(ta,{})}),e.jsx(b,{path:"thank-you",element:e.jsx(ia,{children:e.jsx(Ze,{})})}),e.jsx(b,{path:"blog",element:e.jsx(ea,{})}),e.jsx(b,{path:"blog/:blog",element:e.jsx(aa,{})})]})}),e.jsx(re,{defer:!0,zendeskKey:ra})]})}de.createRoot(document.getElementById("root")).render(e.jsx(le.StrictMode,{children:e.jsx(sa,{})}));
